-- UAP Mindoro Chapter Payment System
...
INSERT INTO site_settings (setting_key, setting_value) VALUES ('logo', 'uploads/uap_logo.jpg');

-- Default admin account (CHANGE THIS PASSWORD AFTER FIRST LOGIN)
-- ID Number: ADMIN001 / password: admin123
INSERT INTO users (name, id_number, password, role, status) VALUES
('Admin', 'ADMIN001', '$2y$10$rhTiIVrjN9Uh/Jj47WMzoeksyWBPC6l/wR7z9qnPb.tb93CKwUpPS', 'admin', 'approved');
